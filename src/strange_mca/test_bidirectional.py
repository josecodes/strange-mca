"""Test script for bidirectional graph traversal."""
...
def main():
    """Run the bidirectional graph test."""
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description="Test bidirectional graph traversal")
    ...
    parser.add_argument("--viz_dir", type=str, default=None,
                        help="Directory to save visualization of the graph (default: None)")
    ...
    print(f"Total nodes in responses: {len(result.get('responses', {}))}")
